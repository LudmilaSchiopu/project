...
//mai sus este ciclu in functie, mai jos - recursia
function pow (x, n) {
    if (n === 1) {
        return x;
    } else {
...
//console.log(getTotalProgressByIteration(students));  //functia prin ciclu/iteratie (fara obj.semi)
...
console.log(result[0]/result[1]);                            //recursie

//cod.ex.#16 (factorial n!)
